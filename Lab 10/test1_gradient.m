...
assert(nansum(abs(PHI(:)))==2475, 'Bad values in the angle-matrix, params of atan are in the right order?');
assert(round(sum(MAG(:)))==14801, 'The calculated magnitude matrix (MAG) maybe not correct');
